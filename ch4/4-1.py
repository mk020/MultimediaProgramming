...
gray = cv.blur(gray, (3,3)) # 스무딩 작업 - 잡음 제거 효과

grad_x=cv.Sobel(gray,cv.CV_32F,1,0,ksize=3)	# 소벨 연산자 적용, sobel_x 왼오
grad_y=cv.Sobel(gray,cv.CV_32F,0,1,ksize=3) # sobel_y 위아래
