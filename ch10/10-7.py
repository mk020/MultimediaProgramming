...
mesh=mp_mesh.FaceMesh(max_num_faces=2,refine_landmarks=True,min_detection_confidence=0.5,min_tracking_confidence=0.5)  # 설정
# 얼굴 최대 2개 검출
...
while True:
    ...
    res=mesh.process(cv.cvtColor(frame,cv.COLOR_BGR2RGB))  # 실행
