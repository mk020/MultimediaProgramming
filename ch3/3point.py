...
img_plus3 = cv.add(img512, opencv_img) # 0~255 + 0~255 = 0~510
cv.imshow('two images - add',img_plus3)

#7
img_plus4 = cv.addWeighted(img512, 0.5, opencv_img, 0.5, 0) # 비율(0.5+0.5=1)
...
ret, img_binaryB = cv.threshold(gray_small, 100, 255, cv.THRESH_BINARY) # 임계값 100
